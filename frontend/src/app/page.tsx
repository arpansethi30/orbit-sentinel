...
export default function HomePage() {
    ...
    return (
      <div className="flex items-center justify-center min-h-96">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading Orbit Sentinel data...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Call to Action */}
      <Card className="p-8 text-center bg-gradient-to-r from-blue-50 to-purple-50 border-blue-100">
        <h3 className="text-2xl font-bold text-gray-900 mb-4">
          Ready to Monitor Space?
        </h3>
        <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
          Access real-time satellite data, collision predictions, and space weather conditions. 
          Built for the H*QUOTIENT SPACE x SEA Hackathon with professional-grade orbital mechanics.
        </p>
